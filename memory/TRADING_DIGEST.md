...
| 🟡 `TP1` ↔ `CONSERVATIVE` | 19 | **+5.97$** |
| 🟡 `CONSERVATIVE` ↔ `CRVUSDT` | 16 | **+5.60$** |
| 🟡 `CONSERVATIVE` ↔ `WLDUSDT` | 15 | **+1.93$** |
| 🟡 `CONSERVATIVE` ↔ `1000BONKUSDT` | 14 | **+3.07$** |
| 🟡 `CONSERVATIVE` ↔ `LINKUSDT` | 14 | **+3.32$** |
| 🟠 `CONSERVATIVE` ↔ `HBARUSDT` | 14 | **-1.76$** |
| 🟡 `CONSERVATIVE` ↔ `ADAUSDT` | 14 | **+0.77$** |
